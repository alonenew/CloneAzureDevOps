    ...
    return (
        <>
            {token && <nav className='px-2 shadow flex h-12 items-center'>
                ...
                <Box className=' text-sm opacity-60 '>
                    <Typography variant="caption" px={1} >becomedev2</Typography>/
                    <Typography variant="caption" px={1} >Miniproject</Typography>/
                    <Typography variant="caption" px={1} >Boards</Typography>/
                    <Typography variant="caption" px={1} >Boards</Typography>
                </Box>
                <Box className='mx-auto'></Box>
                <Search />
                <Box className='pr-4 pl-2.5 flex opacity-50'>
